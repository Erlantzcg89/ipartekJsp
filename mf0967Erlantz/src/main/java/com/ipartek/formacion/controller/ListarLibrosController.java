 ...
 */
@WebServlet("/libros")
public class ListarLibrosController extends HttpServlet {
	private static final long serialVersionUID = 1L;
	
	// Declaración de variables para el uso del controlador

	private final static Logger LOG = Logger.getLogger(ListarLibrosController.class);
