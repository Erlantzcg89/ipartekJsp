...
<div class="container-fluid p-4">
	...
	<main class="ejemplo02-main">
		...
		<p class="text-center">Rellena los parámetros nombre y password
			mediante un formulario</p>

		<div class="ejemplo02-caja-centrado">
			<button type="button" class="btn btn-secondary d-block my-2"
				data-toggle="modal" data-target="#exampleModal">Rellenar
				Parámetros</button>
			<ul>
				<li>Nombre: ${nombre}</li>
			...
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title" id="exampleModalLabel">Introducir
							datos</h5>
