...
public class CursoDAO implements IDAO<Curso>{
	...
	public List<Curso> getAll() {
		...
		String sql = "SELECT c.id 'id_curso', c.nombre 'nombre_curso', c.finicio 'inicio', c.ffin 'fin', c.horas 'horas', c.id_profesor 'profesor' FROM curso c ORDER BY c.id asc LIMIT 500;";
